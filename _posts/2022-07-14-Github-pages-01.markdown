...
![Repository](/assets/img/howTo_github/001/repository.PNG)  
...
![page](/assets/img/howTo_github/001/repository2.PNG)  
...
![Publishing](/assets/img/howTo_github/001/publishing.PNG)
...
![Publishing](/assets/img/howTo_github/001/publishing2.PNG)
...
이러한 원격 저장소에서 작업을 하는 것은 효율이 떨어지므로 **개개인의 작업 환경인 Local 저장소에서 작업 후 Remote 저장소로** 보내주는 작업을 통해야 합니다.  
따라서 Commit(Local 저장소 변경 사항 저장) & Push(Local > Remote)를 통해 블로그를 꾸미고, 글을 쓰는 작업들을 진행 해야합니다.

## 1-4 Github Desktop, VsCode 설치
...
![GithubDesktop](/assets/img/howTo_github/001/githubDesktop.PNG)
...
![Clone](/assets/img/howTo_github/001/githubDesktop2.PNG)
...
![Editor](/assets/img/howTo_github/001/githubDesktop3.PNG)
...
![index.html](/assets/img/howTo_github/001/index_html.PNG)
...
![commit](/assets/img/howTo_github/001/commit.PNG)
...
![push](/assets/img/howTo_github/001/push.PNG)
